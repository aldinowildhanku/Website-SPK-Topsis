...
$s=mysqli_query($con,"select * from kriteria");
$h=mysqli_num_rows($s);
...
$i3=0;
$maxarray=array();
$a2=mysqli_query($con,"select * from kriteria order by id_kriteria asc");
echo "<tr>";
while($da2=mysqli_fetch_assoc($a2)){
		...
		//ambil nilai
			...
			$n2=mysqli_query($con,"select * from nilai_matrik where id_kriteria='$idalt2'  order by id_matrik ASC");
		$jarakp2=0;
		$c2=0;
		$ymax2=array();
		...
		while($dn2=mysqli_fetch_assoc($n2)){
			...
			$nilai_kuadrat2=0;
			$k2=mysqli_query($con,"select * from nilai_matrik where id_kriteria='$idk2' order by id_matrik ASC ");
			...
			$k22=mysqli_query($con,"select * from nilai_matrik where id_kriteria='$idk2'  order by id_matrik ASC ");
...
while($da=mysqli_fetch_assoc($a)){
		...
		//ambil nilai			
			$n=mysqli_query($con,"select * from nilai_matrik where id_alternatif='$idalt' order by id_matrik ASC");
		$jarakp=0;
		$c=0;
		$ymax=array();
		$arraymaks=array();
		while($dn=mysqli_fetch_assoc($n)){
			...
			//nilai kuadrat			
			$nilai_kuadrat=0;
			$k=mysqli_query($con,"select * from nilai_matrik where id_kriteria='$idk' order by id_matrik ASC ");
			...
			$k2=mysqli_query($con,"select * from nilai_matrik where id_kriteria='$idk' order by id_matrik ASC ");
