...
<div class="box-header">
	<h3 class="box-title ">Peringkat dari calon kepala desa berdasarkan persyaratan tertingi</h3>
...
<table class="table table-bordered table-responsive">
	...
	<tbody>
		...
		foreach (@$_SESSION['dplus'] as $key => $dxmin) {
			...
			$sql2 = mysqli_query($con, "insert into nilai_preferensi (nm_alternatif,nilai) values('$nm','$nilai')");
