...
<tr>
<?php
$hk=mysqli_query($con,"select nama_kriteria from kriteria order by id_kriteria asc");
...
<?php
$i=0;
$a=mysqli_query($con,"select * from kriteria order by id_kriteria asc");
echo "<tr>";
while($da=mysqli_fetch_assoc($a)){
		...
		//ambil nilai
			...
			$n=mysqli_query($con,"select * from nilai_matrik where id_kriteria='$idalt'  order by id_matrik ASC");
